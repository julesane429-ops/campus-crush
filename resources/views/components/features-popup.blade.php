...
">
    ...
    ">
        ...
        {{-- Slides — zone scrollable --}}
        <div id="features-slides" style="flex:1; overflow:hidden; min-height:0;">
            <div style="display:flex; height:100%; transition:transform 0.4s cubic-bezier(0.22,1,0.36,1);" id="slides-track">

                {{-- ══ SLIDE 1 : Parrainage ══ --}}
                <div class="feat-slide" style="min-width:100%; overflow-y:auto; padding:28px 20px 16px; box-sizing:border-box;">
                    <div style="text-align:center; margin-bottom:16px;">
                        <div style="font-size:40px; margin-bottom:10px;">🎁</div>
                        <div style="font-size:11px; font-weight:700; letter-spacing:0.10em; margin-bottom:5px;
                            background:linear-gradient(135deg,#a855f7,#ff5e6c);
                            -webkit-background-clip:text; -webkit-text-fill-color:transparent;">
                            NOUVEAUTÉ — PARRAINAGE
                        </div>
                        <h2 style="font-size:18px; font-weight:800; color:#fff; margin-bottom:7px; line-height:1.3;">
                            Invite tes amis,<br>gagne du premium
                        </h2>
                        <p style="font-size:12px; color:rgba(255,255,255,0.45); line-height:1.55;">
                    ...
                    <div style="background:rgba(168,85,247,0.08); border:1px solid rgba(168,85,247,0.18); border-radius:16px; padding:12px 14px; margin-bottom:16px;">
                ...
                <div class="feat-slide" style="min-width:100%; overflow-y:auto; padding:28px 20px 16px; box-sizing:border-box;">
                    ...
                    <div style="background:rgba(255,193,69,0.07); border:1px solid rgba(255,193,69,0.18); border-radius:16px; padding:12px 14px; margin-bottom:16px;">
                        <div style="display:flex; gap:10px; align-items:flex-start; margin-bottom:8px;">
                            <span style="font-size:15px; flex-shrink:0;">👑</span>
                ...
                <div class="feat-slide" style="min-width:100%; overflow-y:auto; padding:28px 20px 16px; box-sizing:border-box;">
                    ...
                    <div style="margin-bottom:14px;">
                        ...
                        ['2', '📱', 'Confirme sur ton téléphone', 'Tu reçois une notification ou un code USSD à valider directement'],
                        ['3', '✅', 'Accès immédiat', 'Dès la confirmation, ton abonnement ou boost est activé automatiquement'],
                        ] as [$num, $icon, $title, $desc])
                        <div style="display:flex; gap:10px; align-items:flex-start; padding:9px 0; border-bottom:1px solid rgba(255,255,255,0.05);">
                            <div style="width:26px; height:26px; border-radius:50%; flex-shrink:0; display:flex; align-items:center; justify-content:center; font-size:11px; font-weight:700; background:rgba(255,94,108,0.15); color:#ff5e6c;">{{ $num }}</div>
                            <div>
                    ...
                    <div style="background:rgba(34,197,94,0.07); border:1px solid rgba(34,197,94,0.18); border-radius:12px; padding:9px 12px; margin-bottom:14px; display:flex; gap:9px; align-items:center;">
                ...
                <div class="feat-slide" style="min-width:100%; overflow-y:auto; padding:28px 20px 16px; box-sizing:border-box;">
                    ...
                    <div style="background:rgba(59,130,246,0.07); border:1px solid rgba(59,130,246,0.18); border-radius:16px; padding:12px 14px; margin-bottom:16px;">
                        <div style="display:flex; gap:10px; align-items:flex-start; margin-bottom:8px;">
                            <span style="font-size:15px; flex-shrink:0;">🌐</span>
                        ...
                        <div style="display:flex; gap:10px; align-items:flex-start; margin-bottom:8px;">
                            <span style="font-size:15px; flex-shrink:0;">💬</span>
                            <p style="font-size:12px; color:rgba(255,255,255,0.55); line-height:1.5;">
                                Partage-le sur WhatsApp, Instagram ou par SMS
                            </p>
                        </div>
                        <div style="display:flex; gap:10px; align-items:flex-start;">
                            <span style="font-size:15px; flex-shrink:0;">💘</span>
                ...
                <div class="feat-slide" style="min-width:100%; overflow-y:auto; padding:28px 20px 16px; box-sizing:border-box;">
                    <div style="text-align:center; margin-bottom:16px;">
                        ...
                        <p style="font-size:12px; color:rgba(255,255,255,0.45); line-height:1.55;">
                            ...
                            La personne reçoit un message mystérieux <strong style="color:#fff;">sans savoir que c'est toi</strong> 👀
                        </p>
                    </div>

                    <div style="background:rgba(255,94,108,0.07); border:1px solid rgba(255,94,108,0.18); border-radius:16px; padding:12px 14px; margin-bottom:16px;">
                        <div style="display:flex; gap:10px; align-items:flex-start; margin-bottom:8px;">
                            <span style="font-size:15px; flex-shrink:0;">💌</span>
                ...
                <div class="feat-slide" style="min-width:100%; overflow-y:auto; padding:28px 20px 16px; box-sizing:border-box;">
                    ...
                    <div style="background:rgba(168,85,247,0.07); border:1px solid rgba(168,85,247,0.18); border-radius:16px; padding:12px 14px; margin-bottom:16px;">
                        <div style="display:flex; gap:10px; align-items:flex-start; margin-bottom:8px;">
                            <span style="font-size:15px; flex-shrink:0;">👩🏾</span>
        ...
        {{-- Navigation bas — toujours visible, collée en bas --}}
        <div style="padding:12px 20px 16px; display:flex; align-items:center; justify-content:space-between; flex-shrink:0; border-top:1px solid rgba(255,255,255,0.05);">
            {{-- Dots --}}
            <div style="display:flex; gap:5px;" id="feat-dots">
            ...
            <div style="display:flex; gap:8px;">
                <button id="feat-prev" onclick="prevSlide()" style="
                    display:none; padding:7px 13px; border-radius:10px; border:none; cursor:pointer;
